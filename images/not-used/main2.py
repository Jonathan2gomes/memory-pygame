...
class Tile(pygame.sprite.Sprite):
    def __init__(self, filename, x, y):
        ...
        self.original_image = pygame.image.load('images/plants/' + filename)

        self.back_image = pygame.image.load('images/plants/' + filename)
...
class Game():
    ...
    def draw(self):
        ...
        info_text = content_font.render('Encontre plantas e flores semelhantes', True, WHITE)
